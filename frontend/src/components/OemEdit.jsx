         ...
         <form className=" flex  justify-evenly" onSubmit={handleSubmit}>
            <div className="flex-col m-5 w-[50%] ">
               ...
               <div className="flex-col  gap-5 mb-2">
                  ...
                  <div className="flex  ">
                     ...
                     <button  className="flex justify-start h-5" onClick={handleAddInput}>▼</button>
                  </div>
            ...
            <div className="flex m-5 ">
                  ...
                  <div className="flex flex-col w-1/4 pr-4 text-gray-600 pt-1">
                     ...
                     <label className=" border-neutral-400 mt-1 mb-4">
                        power
                     </label>
                     <label className=" border-neutral-400 mt-1 mb-4">
                        maxSpeed
                  ...
                  <div className="flex-col w-1/2 pr-4 text-gray-600">
                     ...
                     <input 
                       className=" border border-black shadow  mb-4 bg-gray-200  "
                     type="text" value={mileage} readOnly />
            ...
            <div>
                  <button className=" border-2 border-neutral-400 bg-green-500 shadow hover:bg-green-800 w-[50%] m-5" type="submit">
                  Submit
               </button>
               </div>
               </div>
