    ...
    <div className=" ml-20 mr-20 mb-10 mt-10 border border-black rounded-md">
       ...
       <div className=" flex  justify-evenly ">
               <div>
                  ...
                  <button className='border-2 border-black pl-5 pr-5 bg-green-500 rounded-md text-white ' onClick={()=>cardedit(card._id)} > 
                  Edit    
           </button>
               </div>
               ...
               <div>
                  ...
                  <button className='border-2 border-black pl-5 pr-5 bg-red-500 rounded-md text-white ' onClick={()=>carddelete(card._id)}> 
                 Delete   
           </button>
               </div>
         </div>
